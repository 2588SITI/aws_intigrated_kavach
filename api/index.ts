...
app.get('/api/mock/data', (req, res) => {
  ...
  if (key.includes('RFCOMM_TR')) {
    res.send(`Date,Time,Station Id,Station Name,Direction,Expected,Received,Percentage,Radio
28-03-2026,10:00:00,VAPI,VAPI STATION,Nominal,100,98,98,1
28-03-2026,10:05:00,VAPI,VAPI STATION,Reverse,100,95,95,1
28-03-2026,10:10:00,UVD,UDVADA STATION,Nominal,100,92,92,1
28-03-2026,10:15:00,UVD,UDVADA STATION,Reverse,100,88,88,1
07-04-2026,10:00:00,BIM,BIM STATION,Nominal,1000,976.8,97.68,1
07-04-2026,10:05:00,GVD,GVD STATION,Nominal,10000,9453,94.53,1
07-04-2026,10:10:00,DRD,DRD STATION,Nominal,10000,9457,94.57,1
07-04-2026,10:15:00,PLG,PLG STATION,Nominal,1000,959.4,95.94,1`);
...
28-03-2026,10:00:00,12345,VAPI,VAPI STATION,Nominal,100,99,99,1
28-03-2026,10:05:00,12345,VAPI,VAPI STATION,Reverse,100,97,97,1
07-04-2026,10:00:00,12345,BIM,BIM STATION,Nominal,1000,976.8,97.68,1
07-04-2026,10:05:00,12345,GVD,GVD STATION,Nominal,10000,9453,94.53,1
07-04-2026,10:10:00,12345,DRD,DRD STATION,Nominal,10000,9457,94.57,1
07-04-2026,10:15:00,12345,PLG,PLG STATION,Nominal,1000,959.4,95.94,1`);
  } else if (key.includes('TRNMSNMA')) {
    res.send(`Date,Time,Station Id,Station Name,Radio,Event
28-03-2026,10:00:00,VAPI,VAPI STATION,1,MA Received
28-03-2026,10:05:00,VAPI,VAPI STATION,1,MA Received
07-04-2026,10:00:00,BIM,BIM STATION,1,MA Received
07-04-2026,10:05:00,GVD,GVD STATION,1,MA Received
07-04-2026,10:10:00,DRD,DRD STATION,1,MA Received
07-04-2026,10:15:00,PLG,PLG STATION,1,MA Received`);
  } else {
